...
DJANGO_SUPERUSER_USERNAME=admin DJANGO_SUPERUSER_PASSWORD=abc123 DJANGO_SUPERUSER_EMAIL=someone@microsoft.com python ../mysite/manage.py createsuperuser --noinput
